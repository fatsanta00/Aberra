      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-[#1c0417]/80 border border-purple-500/20 rounded-2xl p-5">
            ...
            <p className="text-3xl font-bold text-white">{minedBalance.toFixed(4)} <span className="text-base text-gray-400">ETH</span></p>
            <Link href="/stake" className="block text-center mt-4 py-2 rounded-lg bg-[#facc15] text-black text-xs font-bold hover:opacity-90 transition">
              Mine More
            </Link>
          </div>
          ...
          <div className="bg-[#1c0417]/80 border border-purple-500/20 rounded-2xl p-5">
            ...
            <p className="text-gray-500 text-xs mt-4">No accumulated earnings yet</p>
          </div>
        </div>
      </section>
